            ...
            <ScrollView style={styles.scrollView}>
                ...
                <Text style={styles.title}>Les règles de la communauté </Text>
                    ...
                    <Text style={styles.fourPart}>
                        * Chacun d’entre vous est impliqué dans la Iconic Community. Si vous voyez un contenu qui semble enfreindre nos règles, n’hésitez pas à nous le signaler.
                        * Il est possible que vous trouviez un contenu que vous n’aimez pas, mais qui respecte les Règles de la communauté. Si tel est le cas, vous pouvez vous désinscrire .
